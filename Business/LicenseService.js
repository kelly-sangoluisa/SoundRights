...
class LicenseService {
  ...
  static async createLicense({ id_song, id_requester_user, status_license, date_start_license, date_end_license }) {
    if (!id_song || !id_requester_user || !status_license) {
      throw new Error('Faltan datos obligatorios para la licencia.');
    }
    return await LicenseRepository.create({ id_song, id_requester_user, status_license, date_start_license, date_end_license });
  }
